...
<img src="https://github.com/user-attachments/assets/07353a36-d760-4216-a5ab-eaa953338a99" alt="A screencast of a Positron session. A script called example.R is open in the editor with some ggplot2 lines, one of which will cause an error. Running the code results in both an error and a note Click to explain or fix the last error." width="100%" />
